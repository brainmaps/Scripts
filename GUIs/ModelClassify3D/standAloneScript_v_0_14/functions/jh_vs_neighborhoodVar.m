function nm = jh_vs_neighborhoodVar(im, minDist, maxDist, anisotropic, debug, nameRun, nameParam)
%UNTITLED6 Summary of this function goes here
%   Detailed explanation goes here

fprintf(['    Variance value of ' num2str(minDist) ' to ' num2str(maxDist) ' neighborhood... ']);
tic;
