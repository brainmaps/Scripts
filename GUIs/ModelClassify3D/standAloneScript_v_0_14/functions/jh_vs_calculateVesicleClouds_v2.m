function [vc, vesicles] = jh_vs_calculateVesicleClouds_v2(im, classScores, classVesiclePredict, labWS, prefType)

% vc = classification.result{2};
...
gauss = jh_dip_gaussianFilter3D(im, 1.2, 3, [1 1 3]);
