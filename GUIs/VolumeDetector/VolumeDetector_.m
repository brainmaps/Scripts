...
addpath(genpath('C:\Daten\MOBI\MPI\Scripts\GUIs\Viewer\v1'));
% And the functions folder
addpath(genpath('C:\Daten\MOBI\MPI\Scripts\GUIs\Functions\v1'));
...
h = VolumeDetector( ...
    'image', { ...
        ...
        'dataType', 'single', ...
        'sourceType', 'cubed', ...
        'sourceFolder', 'C:\Daten\MOBI\MPI\Datasets\20130410.membrane.striatum.10x10x30nm', ...
        'anisotropic', [1 1 3], ...
        'position', [0 0 0] ...
    });
